...
app = FoodOrderingApp()
# Admin details
app.admin_login("Bro123")
app.add_food_item("Tandoori Roti", "4 pieces", 240, 10, 50)
app.add_food_item("Veg Roll", "2 piece", 320, 15, 30)
...
app.admin_logout()
# User deatils
app.user_register("Jansen ", "9978567890", "jan@mail.com", "123 church street", "password143")
user = app.user_login("jan@mail.com", "password143")
app.place_order(user, [1, 2])
app.place_order(user, [3])  
app.view_order_history(user)
app.update_user_profile(user, "John Doe", "9876543210", "456 Elm Street", "newpassword123")
